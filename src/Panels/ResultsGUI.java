...
public class ResultsGUI extends javax.swing.JFrame {
    ...
    public ResultsGUI(DefaultTableModel model, double score){
        this(); 
        this.jTable1.setModel(model);
        this.setVisible(true);
        this.score = score; 
        this.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        this.setTitle("Presentation of Results");
       // this.jLabel1.setText("Your score is " + Double.toString(this.score) );
    }
    /**
